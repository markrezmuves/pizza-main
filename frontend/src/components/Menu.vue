<template>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container-fluid">
      <router-link class="navbar-brand" to="/" @click="onClickMenu(1)">Pizzéria</router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <router-link class="nav-link" :class="{active: menuState === 2}" to="/" @click="onClickMenu(2)">Home</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" :class="{active: menuState === 3}" to="/about" @click="onClickMenu(3)">About</router-link>
          </li>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Counter</a>
            <ul class="dropdown-menu">
              <li>
                <router-link class="dropdown-item" :class="{active: menuState === 5}" to="/count1" @click="onClickMenu(5)">Counter1</router-link>
              </li>
              <li>
                <router-link class="dropdown-item" :class="{active: menuState === 6}" to="/count2" @click="onClickMenu(6)">Counter2</router-link>
              </li>
            </ul>
          </li>
